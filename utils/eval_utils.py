...
@torch.no_grad()
def evaluation_esmotion(out_dir, val_loader, ema_ESMotion, ae, writer, ep, best_fid, best_div,
    ...
    for i, batch in enumerate(tqdm(val_loader)):
        ...
        if i < num_mm_batch:
            ...
            for _ in tqdm(range(30)):
                pred_latents = ema_ESMotion.generate(clip_text, m_length//4 , time_steps, cond_scale,
